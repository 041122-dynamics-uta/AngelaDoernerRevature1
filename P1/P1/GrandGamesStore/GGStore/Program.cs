...
using GGStoreDomain;
using GGRecordStoreModel;
using Repo;
using GGStore;

namespace GGRecordStore
{
    class Program
    {
        ...
        {   
            GGRepoClass drc = new GGRepoClass();
            ...
            void Greeting() 
            { 
                Console.WriteLine("Welcome to Grander Games!");
                Console.WriteLine("A Grand Place to Provide for All your Grand Gamer Needs\n ");
            }
            ...
            {
                case 1:
                    Console.WriteLine("Grander Games");
                    store = false;
                    break;
                case 2:
                    Console.WriteLine("Grandios Games");
                    store = false;
                    break;
                default:
